...
<body>
        <nav>
            <div class="profile">
            <a href= "" class="img"><img class="logo" src="<?php echo base_url('/public/image/GSB.png'); ?>" profile photo></a>
            </div>
        </nav>
    <div id="container">
        <!-- zone de connexion -->
    ...
    <!-- Zone de création pour un nouvelle utilisateur en popup JS-->
    <div class="popup">
    ...
    <script src="<?php echo base_url('/public/js/gsb.js'); ?>"></script>
